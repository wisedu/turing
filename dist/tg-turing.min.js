...
exports.default = {
    ...
    methods: {
        handleSyncChange: function handleSyncChange(val, name) {
            debugger;
...
var _newArrowCheck2 = __webpack_require__(18);
...
exports.moment = exports.axios = exports.mintForm = exports.iviewForm = exports.FormConnectItem = exports.DataSourceManager = exports.DataAdapter = exports.author = exports.description = exports.version = exports.utils = undefined;
...
var _FormConnectItem = __webpack_require__(36);

var _FormConnectItem2 = _interopRequireDefault(_FormConnectItem);

var _form = __webpack_require__(56);

var _form2 = _interopRequireDefault(_form);

var _form3 = __webpack_require__(57);

var _form4 = _interopRequireDefault(_form3);

var _DataAdapter = __webpack_require__(117);

var _DataSourceManager = __webpack_require__(121);

var _tgContainer = __webpack_require__(122);

var _tgContainer2 = _interopRequireDefault(_tgContainer);

var _tgDiv = __webpack_require__(126);

var _tgDiv2 = _interopRequireDefault(_tgDiv);

var _tgForm = __webpack_require__(130);

var _tgForm2 = _interopRequireDefault(_tgForm);

var _tgImg = __webpack_require__(134);

var _tgImg2 = _interopRequireDefault(_tgImg);

var _tgLeftRightItem = __webpack_require__(138);

var _tgLeftRightItem2 = _interopRequireDefault(_tgLeftRightItem);

var _tgLeftRight = __webpack_require__(142);

var _tgLeftRight2 = _interopRequireDefault(_tgLeftRight);

var _tgLinkbutton = __webpack_require__(146);

var _tgLinkbutton2 = _interopRequireDefault(_tgLinkbutton);

var _tgListview = __webpack_require__(149);

var _tgListview2 = _interopRequireDefault(_tgListview);

var _tgText = __webpack_require__(154);

var _tgText2 = _interopRequireDefault(_tgText);

var _iviewFcForm = __webpack_require__(157);

var _iviewFcForm2 = _interopRequireDefault(_iviewFcForm);

var _iviewFcStatic = __webpack_require__(161);

var _iviewFcStatic2 = _interopRequireDefault(_iviewFcStatic);

var _mintFcForm = __webpack_require__(165);

var _mintFcForm2 = _interopRequireDefault(_mintFcForm);

var _mintFcStatic = __webpack_require__(169);

var _mintFcStatic2 = _interopRequireDefault(_mintFcStatic);
...
var components = {
    TgContainer: _tgContainer2.default, TgDiv: _tgDiv2.default, TgForm: _tgForm2.default, TgImg: _tgImg2.default, TgLeftRightItem: _tgLeftRightItem2.default, TgLeftRight: _tgLeftRight2.default, TgLinkbutton: _tgLinkbutton2.default, TgListview: _tgListview2.default, TgText: _tgText2.default, IviewFcForm: _iviewFcForm2.default, IviewFcStatic: _iviewFcStatic2.default, MintFcForm: _mintFcForm2.default, MintFcStatic: _mintFcStatic2.default
};
...
exports.default = (0, _assign2.default)({}, (0, _extends3.default)({
    ...
    utils: _utils2.default, version: version, description: description, author: author,
    DataAdapter: _DataAdapter.DataAdapter, DataSourceManager: _DataSourceManager.DataSourceManager, FormConnectItem: _FormConnectItem2.default,
    iview: { form: _form2.default }, mint: { form: _form4.default },
    axios: _axios2.default, moment: _moment2.default
}));
...
exports.FormConnectItem = _FormConnectItem2.default;
exports.iviewForm = _form2.default;
exports.mintForm = _form4.default;
...
var DataAdapter = exports.DataAdapter = function () {
    ...
    (0, _createClass3.default)(DataAdapter, [{
        ...
        value: function findAll(param) {
            var bfCallback = this.beforeFindAll;
            var afCallback = this.afterFindAll;
            var that = this;
...
var _FormConnector = __webpack_require__(37);
...
var _ComDataBindBase = __webpack_require__(152);
...
exports.default = {
    ...
    methods: {
        ...
        DataBind: function DataBind(params, ctlparams, callback) {
            var that = this;
...
exports.default = {
    ...
    extends: _FormConnector2.default,
    components: {
        TgListview: TgListview, IviewFcStatic: IviewFcStatic, IviewFcText: IviewFcText
    },
    data: function data() {
        var _this = this;

        return {
            tglistFields: this.fields.map(function (item) {
                (0, _newArrowCheck3.default)(this, _this);
    ...
    return _c('div', [_c('Form', {
      ...
      scopedSlots: _vm._u([{
        ...
        fn: function fn(props) {
          return props.data.hidden !== true ? [_vm._t(props.data.name, [_c(_vm.registedComponentList(props.data, _vm.iviewForm, 'iview-fc-static', props.index), {
            ref: 'field_' + props.data.name,
            tag: "component",
            attrs: {
              "model": props.data,
              "caption": props.data.caption,
              "xtype": props.data.xtype,
            ...
            on: {
              "sync-change": _vm.handleSyncChange
            },
            model: {
              value: _vm.formValue[props.data.name],
              callback: function callback($$v) {
                _vm.$set(_vm.formValue, props.data.name, $$v);
              },
              expression: "formValue[props.data.name]"
            }
          })], {
            model: props.data,
            value: _vm.formValue[props.data.name]
...
exports.default = {
    ...
    extends: _FormConnectItem2.default
};
...
module.exports = { render: function render() {
    var _vm = this;var _h = _vm.$createElement;var _c = _vm._self._c || _h;
    return _c('div', {
      staticClass: "emapm-form",
      class: {
        'emapm-form-readonly': _vm.readonly
      }
    }, _vm._l(_vm.fields, function (metaItem) {
      return _c('div', {
        key: metaItem.name,
        staticClass: "emapm-item"
      }, [_vm._t(metaItem.name, [_c(_vm.registedComponentList(_vm.props.data, _vm.mintForm, 'mint-fc-static'), {
        ref: 'field' + metaItem.name,
        refInFor: true,
        tag: "component",
        attrs: {
          "model": metaItem,
          "display-value": _vm.formValue[metaItem.displayName],
          "options": _vm.optionsMap[metaItem.name]
        },
        on: {
          "sync-change": _vm.handleSyncChange,
          "update:displayValue": function updateDisplayValue($event) {
            _vm.$set(_vm.formValue, metaItem.displayName, $event);
          }
        },
        model: {
          value: _vm.formValue[metaItem.name],
          callback: function callback($$v) {
            _vm.$set(_vm.formValue, metaItem.name, $$v);
          },
          expression: "formValue[metaItem.name]"
        }
      })], {
        model: metaItem,
        displayValue: _vm.formValue[metaItem.displayName],
        value: _vm.formValue[metaItem.name]
      })], 2);
    }));
  }, staticRenderFns: [] };
