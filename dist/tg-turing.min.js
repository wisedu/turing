...
var _vaildateRules = __webpack_require__(134);
...
utils.addChildToTreeData = function (allData, parentData, opt) {
  var parent_id = parentData[opt.ukey];
...
var _accountingJs = __webpack_require__(132);

var _accountingJs2 = _interopRequireDefault(_accountingJs);

var _ConnectItem = __webpack_require__(133);
    ...
    methods: {
        ...
        initGrid: function initGrid() {
            ...
            if (this.columnsCopy.length > 0) {
                ...
                this.inst = new EditableGrid(this.$refs.editableGrid, (0, _assign2.default)({}, this.params, { displayFieldFormat: this.displayFieldFormat, columnAutosizing: this.columnAutosizing }));
                        ...
                        case "tree":
                            if (model.dict !== undefined) {
                                _Defaults2.default.getDictTreeData[0](model.dict, { key: value }, function (datas) {
                                    ...
                                    var treedatas = _that.inst.utils.toTreeData(correntDatas, "", { ukey: "id", pkey: 'pId', toCKey: 'children' });
                                    if (treedatas.length) {
                                        callback(treedatas);
                                    } else {
