(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("tg-turing", [], factory);
	else if(typeof exports === 'object')
		exports["tg-turing"] = factory();
	else
		root["tg-turing"] = factory();
...
var _vaildateRules = __webpack_require__(135);

var _vaildateRules2 = _interopRequireDefault(_vaildateRules);
...
exports.default = {
    ...
    getDictData: [function (dict, params, callback) {
        ...
        var filterparams = dict.params || {};
        if (params !== undefined && params.key !== "") {
            var newparam = {};
            newparam[dict.label] = params.key;
            (0, _assign2.default)(filterparams, newparam);
        }
        _utils2.default.Post(dict.url, { where: filterparams }).then(function (result) {
    ...
    getDictTreeData: [function (dict, params, callback) {
        ...
        _utils2.default.Post(dict.url, filterparams).then(function (result) {
            ...
            try {
                datas = result.data.map(function (item) {
                    ...
                    item["label"] = item[dict.label], item["value"] = item[dict.value];
                    return item;
                }.bind(this));
                datas = _utils2.default.toTreeData(datas, "", { ukey: "id", pkey: 'parentid', toCKey: 'children' });
                callback(datas);
            } catch (e) {
    ...
    getDictTreeDataAsync: [function (dict, params, callback) {
        ...
        _utils2.default.Post(dict.url, { "id": params.key, "checkParent": true }).then(function (result) {
    ...
    validateRules: _vaildateRules2.default,
    displayFieldFormat: ""
};
...
utils.extend = function extend() {
  ...
  if (target == null || (typeof target === 'undefined' ? 'undefined' : (0, _typeof3.default)(target)) !== 'object' && typeof target !== 'function') {
    target = {};
  }
...
exports.QuerySettingBuilder = undefined;
...
var QuerySettingBuilder = exports.QuerySettingBuilder = function () {
    function QuerySettingBuilder() {
        (0, _classCallCheck3.default)(this, QuerySettingBuilder);
    }

    (0, _createClass3.default)(QuerySettingBuilder, null, [{
        key: 'EMAP',
        value: function EMAP(form_data) {
            var model = this.searchDefine.meta;
            var operate_blank_value = true;
            var condition = [];
            ...
            var _loop = function _loop(k) {
                ...
                if (/_DISPLAY$/.test(k)) return 'continue';
                var modelItem = model.filter(function (item) {
                    return item.name == k;
                })[0];
                if (!modelItem) return 'continue';
                var item_filter = {
                    name: k,
            ...
            var result = _adaptCondition(condition, model);
                                ...
                                if (condition_item.value !== undefined && condition_item.value !== null) {
                                    ...
                                    condition_item.value = condition_item.value === null ? '' : numVal * 1;
                                        ...
                                        if (condition_item.value !== '@__blank__value' && /,/.test(condition_item.value)) {
                                            ...
                                            var date_value = condition_item.value;
                                            if (date_value[0] !== "") {
        ...
        key: 'lite',
        value: function lite(params) {
            if ((0, _keys2.default)(params).length > 0 && !params.querySetting) {
                var query = [];
                ...
                return (0, _stringify2.default)(query);
            } else {
                return undefined;
            }
        }
        ...
        key: 'sequelize',
        value: function sequelize(searchValues, defaultScope, ignoreEmpty) {
            var _this = this;

            var ie = ignoreEmpty === undefined ? true : ignoreEmpty;
            var newQS = {};
            newQS[defaultScope] = {};
            for (var key in searchValues) {
                var element = searchValues[key];
                if (ie) {
                    if (element === "") {
                        continue;
                    } else if (element instanceof Array && !element.some(function (item) {
                        (0, _newArrowCheck3.default)(this, _this);
                        return item !== "";
                    }.bind(this))) {
                        continue;
                ...
                if (key.indexOf("@") > -1) {
                    var newScope = key.substring(0, key.indexOf("@"));
                    var newKey = key.substring(key.indexOf("@") + 1, key.length);
...
exports.default = {
    props: {
        ...
        displayFieldFormat: {
            type: String,
            default: function _default() {
                if (_Defaults2.default.displayFieldFormat !== undefined) {
                    return _Defaults2.default.displayFieldFormat;
                } else {
    ...
    data: function data() {
        return {
            formDisplay: {},
            optionsMap: {},
            formValue: _utils2.default.cleanProps(this.value)
        };
    },
    ...
    watch: {
        value: {
            handler: function handler(newValue) {
                this.formValue = _utils2.default.cleanProps(newValue);
            },
            deep: true
        }
    },
    methods: {
        registedComponentList: function registedComponentList(model, connectorItems, defaultXtype, index) {
            var xtype = model.xtype;
            var caption = model.caption;
            if (xtype === undefined) {
                console.warn("Turing FormConnector: field " + String(caption) + "'s xtype is undefined, instead of using 'static'.", model, index);
                return connectorItems['static'].name;
            } else if (connectorItems[xtype] === undefined) {
                console.warn("Turing FormConnector: field " + String(caption) + "'s xtype '" + String(xtype) + "' is undefined, instead of using '" + String(defaultXtype) + "'.", model, index);
                return connectorItems[defaultXtype].name;
            } else {
                return connectorItems[xtype].name;
            }
        },
        updateValue: function updateValue(name, value, display, model) {
            if (value === null) value = "";
            if (value === "") {
        ...
        getDisplay: function getDisplay(name) {
            if (name === undefined) {
...
var _QuerySettingBuilder = __webpack_require__(45);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var DataAdapter = exports.DataAdapter = function () {
    function DataAdapter(meta) {
        (0, _classCallCheck3.default)(this, DataAdapter);
        this.events = {
            onLoad: null,
            onLoadMeta: null,
            onRefreshed: null
        ...
        this.querySetting = undefined;
        this.querySettingBuilder = _QuerySettingBuilder.QuerySettingBuilder.sequelize;
    ...
    (0, _createClass3.default)(DataAdapter, [{
        key: 'initView',
        value: function initView(views) {
            this.viewDefine = views;
        }
    }, {
        key: 'getView',
        value: function getView(viewId) {
            var views = this.viewDefine;
            if (views === undefined || views[viewId] === undefined) {
                throw String(this.name) + ' \u7F3A\u5C11 ' + String(viewId) + ' \u6A21\u578B\u5B9A\u4E49';
            }
            var result = {};
            for (var prop in views[viewId]) {
                result[prop] = {};

                if (prop.startsWith("group:[")) {
                    var newGroupItem = {};
                    var groupItems = views[viewId][prop].items;
                    for (var item in groupItems) {
                        newGroupItem[item] = {};
                        _utils2.default.extend(true, newGroupItem[item], views["default"][item], groupItems[item]);
                    }
                    result[prop].title = prop.match(/\[(.*?)\]/)[1];
                    result[prop].items = newGroupItem;
                    result[prop].desc = views[viewId][prop].desc;
                } else {
                    _utils2.default.extend(true, result[prop], views["default"][prop], views[viewId][prop]);
                }
            }
            return result;
        }
        ...
        key: 'initData',
        value: function initData(viewId) {
            var views = this.viewDefine;
            var result = {};
            for (var prop in views[viewId]) {
                if (prop.startsWith("group:[")) {
        ...
        key: 'execute',
        value: function execute(action, data) {
            var _this = this;
            ...
            var matchs = url.match(/\{(.*?)\}/ig);
            matchs = matchs === null ? [] : matchs;
            matchs.map(function (item) {
                (0, _newArrowCheck3.default)(this, _this);
            ...
            if (method.toLowerCase() === "post") {
                return _axios2.default.post(url, params, config).catch(function (e) {
                    (0, _newArrowCheck3.default)(this, _this);
                ...
                return _axios2.default.delete(url, config).catch(function (e) {
                    (0, _newArrowCheck3.default)(this, _this);
                ...
                return _axios2.default.get(url, (0, _assign2.default)({ params: params }, config)).catch(function (e) {
                    (0, _newArrowCheck3.default)(this, _this);
        ...
        value: function findAll(param) {
            ...
            var defaultParams = {
                where: _utils2.default.extend(true, {}, (this.actions.findAll || this.actions.find).params, param || {})
            };

            var orders = (this.actions.findAll || this.actions.find).orders || [];
            ...
            defaultParams = _Defaults2.default.beforeFindAll[0](this.actions.findAll || this.actions.find, defaultParams, {
                pageNumber: this.pageNumber,
                pageSize: this.pageSize
            });

            return this.execute(this.actions.findAll || this.actions.find, defaultParams).then(function (result) {
                return _Defaults2.default.afterFindAll[0](result, that.actions.findAll || that.actions.find, defaultParams);
            });
        }
    }, {
        key: 'findById',
        ...
        value: function save(data) {
            ...
            var processedData = _Defaults2.default.beforeSave[0](this.actions.save, data, this.viewDefine);
            return this.execute(this.actions.save, processedData).then(function (result) {
                (0, _newArrowCheck3.default)(this, _this2);

                return _Defaults2.default.afterSave[0](result, this.viewDefine);
            }.bind(this));
        }
    }, {
        key: 'order',
        ...
        key: 'onFetching',
        value: function onFetching(status, result) {
            switch (status) {
                case "doing":
                    break;
                case "done":
...
exports.uuid = exports.accounting = exports.moment = exports.axios = exports.defaults = exports.DocConnector = exports.FormConnector = exports.ConnectItem = exports.DataSourceManager = exports.DataAdapter = exports.QuerySettingBuilder = exports.EMAPDataAdapter = exports.author = exports.description = exports.version = exports.utils = undefined;
...
var _accountingJs = __webpack_require__(133);

var _accountingJs2 = _interopRequireDefault(_accountingJs);

var _ConnectItem = __webpack_require__(134);

var _ConnectItem2 = _interopRequireDefault(_ConnectItem);

var _FormConnector = __webpack_require__(74);

var _FormConnector2 = _interopRequireDefault(_FormConnector);

var _DocConnector = __webpack_require__(136);

var _DocConnector2 = _interopRequireDefault(_DocConnector);

var _QuerySettingBuilder = __webpack_require__(45);

var _EMAPDataAdapter = __webpack_require__(140);

var _DataAdapter = __webpack_require__(83);

var _DataSourceManager = __webpack_require__(172);

var _Defaults = __webpack_require__(12);

var _Defaults2 = _interopRequireDefault(_Defaults);

var _tgCollectionView = __webpack_require__(173);

var _tgCollectionView2 = _interopRequireDefault(_tgCollectionView);

var _tgContainer = __webpack_require__(177);

var _tgContainer2 = _interopRequireDefault(_tgContainer);

var _tgDiv = __webpack_require__(181);

var _tgDiv2 = _interopRequireDefault(_tgDiv);

var _tgEditableGrid = __webpack_require__(185);

var _tgEditableGrid2 = _interopRequireDefault(_tgEditableGrid);

var _tgForm = __webpack_require__(189);

var _tgForm2 = _interopRequireDefault(_tgForm);

var _tgGridview = __webpack_require__(193);

var _tgGridview2 = _interopRequireDefault(_tgGridview);

var _tgIcon = __webpack_require__(197);

var _tgIcon2 = _interopRequireDefault(_tgIcon);

var _tgImg = __webpack_require__(201);

var _tgImg2 = _interopRequireDefault(_tgImg);

var _tgLeftRightItem = __webpack_require__(205);

var _tgLeftRightItem2 = _interopRequireDefault(_tgLeftRightItem);

var _tgLeftRight = __webpack_require__(209);

var _tgLeftRight2 = _interopRequireDefault(_tgLeftRight);

var _tgLinkbutton = __webpack_require__(213);

var _tgLinkbutton2 = _interopRequireDefault(_tgLinkbutton);

var _tgListview = __webpack_require__(216);

var _tgListview2 = _interopRequireDefault(_tgListview);

var _tgPerson = __webpack_require__(220);

var _tgPerson2 = _interopRequireDefault(_tgPerson);

var _tgText = __webpack_require__(224);

var _tgText2 = _interopRequireDefault(_tgText);

var _tgToolbar = __webpack_require__(228);

var _tgToolbar2 = _interopRequireDefault(_tgToolbar);

var _tgValidator = __webpack_require__(232);

var _tgValidator2 = _interopRequireDefault(_tgValidator);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var version = "1.30.4";
var description = "turing components";
var author = "金智教育 wisedu";
var components = {
    TgCollectionView: _tgCollectionView2.default, TgContainer: _tgContainer2.default, TgDiv: _tgDiv2.default, TgEditableGrid: _tgEditableGrid2.default, TgForm: _tgForm2.default, TgGridview: _tgGridview2.default, TgIcon: _tgIcon2.default, TgImg: _tgImg2.default, TgLeftRightItem: _tgLeftRightItem2.default, TgLeftRight: _tgLeftRight2.default, TgLinkbutton: _tgLinkbutton2.default, TgListview: _tgListview2.default, TgPerson: _tgPerson2.default, TgText: _tgText2.default, TgToolbar: _tgToolbar2.default, TgValidator: _tgValidator2.default
};
var install = function install(Vue) {
    ...
    Vue.directive('tg-funckey', {
        inserted: function inserted(el, binding) {
            ...
            var authkeys = [];
            var authkeys_str = window.sessionStorage.getItem("tg-authkeys");
            if (authkeys_str !== undefined && authkeys_str !== null) {
                authkeys = authkeys_str.split(",");
            }
            var funckeys = binding.value.split(",");

            var hasKey = false;
            if (authkeys.some(function (item) {
                (0, _newArrowCheck3.default)(this, _this2);
                return funckeys.indexOf(item) > -1;
            }.bind(this))) {
                hasKey = true;
            }
    ...
    Vue.filter('date', function (value, format) {
        ...
        var newstr = (0, _moment2.default)(value).format(format);
        return newstr;
    });
    ...
    Vue.filter('currency', function (value) {
        ...
        var format = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : '%s%v';
        ...
        var decimal = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : '.';

        if (value === undefined || value === null || value === "") return '';
        value = value.toString();
        return _accountingJs2.default.formatMoney(value, { symbol: symbol, precision: precision, thousand: thousand, decimal: decimal, format: format });
    });
    Vue.filter('percent', function (value, precision, thousand, decimal) {
        if (value === undefined || value === null || value === "") return '';
        return _accountingJs2.default.formatNumber(value, { precision: precision, thousand: thousand, decimal: decimal });
    });
};
...
exports.default = (0, _assign2.default)({}, (0, _extends3.default)({
    install: install }, components, {
    utils: _utils2.default, version: version, description: description, author: author, EMAPDataAdapter: _EMAPDataAdapter.EMAPDataAdapter, QuerySettingBuilder: _QuerySettingBuilder.QuerySettingBuilder,
    DataAdapter: _DataAdapter.DataAdapter, DataSourceManager: _DataSourceManager.DataSourceManager, ConnectItem: _ConnectItem2.default, FormConnector: _FormConnector2.default, DocConnector: _DocConnector2.default, defaults: _Defaults2.default,
    axios: _axios2.default, moment: _moment2.default, accounting: _accountingJs2.default, uuid: _uuid2.default
}));
exports.utils = _utils2.default;
exports.version = version;
exports.description = description;
exports.author = author;
exports.EMAPDataAdapter = _EMAPDataAdapter.EMAPDataAdapter;
exports.QuerySettingBuilder = _QuerySettingBuilder.QuerySettingBuilder;
exports.DataAdapter = _DataAdapter.DataAdapter;
exports.DataSourceManager = _DataSourceManager.DataSourceManager;
exports.ConnectItem = _ConnectItem2.default;
exports.FormConnector = _FormConnector2.default;
exports.DocConnector = _DocConnector2.default;
exports.defaults = _Defaults2.default;
exports.axios = _axios2.default;
exports.moment = _moment2.default;
exports.accounting = _accountingJs2.default;
...
exports.EMAPDataAdapter = undefined;
...
var _DataAdapter2 = __webpack_require__(83);
...
var EMAPDataAdapter = exports.EMAPDataAdapter = function (_DataAdapter) {
    (0, _inherits3.default)(EMAPDataAdapter, _DataAdapter);

    function EMAPDataAdapter(Adapter) {
        (0, _classCallCheck3.default)(this, EMAPDataAdapter);

        var _this = (0, _possibleConstructorReturn3.default)(this, (EMAPDataAdapter.__proto__ || (0, _getPrototypeOf2.default)(EMAPDataAdapter)).call(this));

        _this.querySettingBuilder = _QuerySettingBuilder.QuerySettingBuilder.lite;

        _this.Adapter = Adapter;
        _this.searchDefine = {};
        _this.builderList = [];
        _this.__baseUrl = "";return _this;
    }

    (0, _createClass3.default)(EMAPDataAdapter, [{
        key: 'view',
        value: function view(name, params) {
        ...
        key: 'load',
        value: function load(uri, modelName, findParams) {
            var self = this;
            var url = "";
            ...
            this.__baseUrl = uri;
            return _axios2.default.get(url, { params: { "*json": 1 } }).then(function (res) {
                var data = res.data;
        ...
        value: function () {
            ...
            var _ref = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee(emapActionName) {
                var path, res, metas;
                return _regenerator2.default.wrap(function _callee$(_context) {
                    while (1) {
                        switch (_context.prev = _context.next) {
                            ...
                            case 6:
                                _context.next = 8;
                                return _axios2.default.get(path, { params: { "*searchMeta": 1 } });
                            ...
                            case 8:
                                ...
                                metas = this.searchDefine.controls.map(function (metaItem) {
                                    var newItem = metaItem;
                                    for (var prop in metaItem) {
                                        if (prop.indexOf(".") > -1) {
                                            var temp = prop.split(".");
                                            var proptype = temp[0];
                                            var prop_name = temp[1];
                                            if (proptype === "search") {
                                ...
                                return _context.abrupt('return', metas);
        ...
        key: 'getIntegratedModel',
        value: function getIntegratedModel(uri, modelName, findParams) {
            this.__baseUrl = uri;
            var url = "";
            if ([".", "/"].indexOf(uri.substring(0, 1)) > -1) {
                url = window.apiPath + uri;
            ...
            return _axios2.default.get(url, { params: { "*json": 1 } }).then(function (res) {
                ...
                var hasModel = res.data.models.filter(function (item) {
                    (0, _newArrowCheck3.default)(this, _this2);
                ...
                if (hasModel.length > 0) {
                    ...
                    if (formModel && formModel.length > 0) {
                        return _axios2.default.get(_utils2.default.getContextPath() + '/sys/emapflow/definition/queryFormActions.do', { params: findParams }).then(function (resp) {
                            try {
        ...
        key: 'refresh',
        value: function refresh(data, modelName, findParams) {
            ...
            if (this.actions[modelName] !== undefined) {
                (0, _assign2.default)(this.actions.findAll, this.actions[modelName]);
            }
        }
    }, {
        key: 'loadMeta',
        value: function loadMeta(controls) {
            ...
            for (var i = 0; i < controls.length; i++) {
                ...
                category_meta.push(JSON.parse((0, _stringify2.default)(control)));
            }
        ...
        key: 'EMAPFieldFilter',
        value: function EMAPFieldFilter(metas) {
            var _this3 = this;
                    ...
                    if (prop.indexOf(".") > -1) {
                        ...
                        switch (prop_name) {
                            ...
                            case "checkType":
                                ...
                                var checkType = metaItem[prop_name].replace(/\[|\]|\"|\{|\}|custom/g, "");
            ...
            if (groupNames.length > 0) {
                ...
                groupNames.map(function (group) {
                    ...
                    var newItem = newForm['group:[' + String(group) + ']'] = {
                        items: {}
                    };
                    for (var key in struct["form"]) {
                        var item = struct["form"][key];
...
var DataSourceManager = exports.DataSourceManager = function () {
    function DataSourceManager(name, url, params) {
        (0, _classCallCheck3.default)(this, DataSourceManager);
    ...
    (0, _createClass3.default)(DataSourceManager, null, [{
        key: "set",
        value: function set(ds) {
            this._ds[ds.name] = ds;
        }
    }, {
        key: "get",
        ...
        value: function ready(callback) {
            ...
            if (dss.length > 0) {
                _axios2.default.all(dss).then(function () {
                    callback();
                });
            } else {
                callback();
...
var _ComDataBindBase = __webpack_require__(47);

var _ComDataBindBase2 = _interopRequireDefault(_ComDataBindBase);
...
exports.default = {
    ...
    extends: _ComDataBindBase2.default,
    props: {
        searcher: Object,
        grid: Object,
        datas: [Array, Object],
        type: {
            type: String,
            default: function _default() {
                if (_Defaults2.default.currentType !== undefined) {
                    return _Defaults2.default.currentType;
                } else {
    ...
    methods: {
        reload: function reload(pager, callback) {
            if (this.dataAdapter !== undefined && this.dataAdapter.querySettingBuilder !== undefined && this.dataAdapter.actions.findAll.url !== "") {
                this.dataAdapter.querySetting = this.dataAdapter.querySettingBuilder((0, _assign2.default)({}, this.formValue, this.filterValues), this.dataAdapter.name, false);
        ...
        tableReload: function tableReload(pageNumber, pageSize) {
        ...
        searchReload: function searchReload() {
...
module.exports = { render: function render() {
    ...
    return _c('div', {
      staticClass: "tg-collection-view-wrap"
    }, [_vm.searcher !== undefined ? _c(_vm.type + '-gb-' + _vm.searcher.name, _vm._b({
      tag: "component",
      attrs: {
        "model": _vm.formValue,
        "displayFieldFormat": _vm.displayFieldFormat
      },
      on: {
        "on-value-change": _vm.updateValue,
        "search": _vm.searchReload,
        "clear": _vm.searchClear
      }
    }, 'component', _vm.searcher, false), [_vm._l(_vm.searcher.fields, function (model) {
      return _vm._t('search-' + model.name, null, {
        slot: 'search-' + model.name
      });
    })], 2) : _vm._e(), _vm._v(" "), _vm.showToolbar ? _c('tg-toolbar', [_vm._t("toolbar-left", null, {
      slot: "left"
    }), _vm._v(" "), _vm._t("toolbar-right", null, {
      slot: "right"
    })], 2) : _vm._e(), _vm._v(" "), _c(_vm.type + '-gb-collection', {
      tag: "component",
      attrs: {
        "grid": _vm.grid,
        "datas": _vm.table_data,
        "pager": _vm.pager,
        "displayFieldFormat": _vm.displayFieldFormat
      },
      on: {
        "reload": _vm.tableReload
      },
      scopedSlots: _vm._u([{
        key: "itemTemplate",
        fn: function fn(props) {
          return [_vm._t("itemTemplate", null, {
            data: props.data,
            index: props.index
          })];
        }
      }, {
        key: "alternateTemplate",
        fn: function fn(props) {
          return [_vm._t("alternateTemplate", null, {
            data: props.data,
            index: props.index
          })];
        }
...
exports.default = {
    ...
    }, (0, _defineProperty3.default)(_props, "params", {
        type: Object,
        default: function _default() {
            return {};
        }
    }), (0, _defineProperty3.default)(_props, "rowRending", Function), (0, _defineProperty3.default)(_props, "readonly", Boolean), _props),
    data: function data() {
        return {
            inst: null,
            activedIndex: -1,
    ...
    computed: {
        autoHeight: function autoHeight() {
            var actual = (this.value instanceof Array ? this.value.length + 1 : 1) * 50;
            if (this.height !== -1) {
                actual = this.height;
            }
    ...
    methods: {
        ...
        removeActivedRow: function removeActivedRow() {
            if (this.value instanceof Array && this.value.length > 0) {
                var removeRow = this.value.splice(this.activedIndex, 1);
        ...
        initGrid: function initGrid() {
            ...
            if (this.columns.length > 0) {
                ...
                this.inst = new EditableGrid(this.$refs.editableGrid, (0, _assign2.default)({}, this.params, { displayFieldFormat: this.displayFieldFormat }));
                var that = this;
                    ...
                    switch (model.xtype) {
                        case "tree":
                            if (model.dict !== undefined) {
                                _Defaults2.default.getDictTreeData[0](model.dict, { key: value }, function (datas) {
                                    (0, _newArrowCheck3.default)(this, _this);

                                    var correntDatas = datas;
                                    correntDatas = correntDatas.map(function (data) {
                                        data.text = data.label || data.name;
                                        return data;
                                    });
                                    var treedatas = that.inst.utils.toTreeData(correntDatas, "", { ukey: "id", pkey: 'pId', toCKey: 'children' });
                                    if (treedatas.length) {
                                        callback(treedatas);
                                    } else {
                        ...
                        default:
                            if (model.dict !== undefined) {
                                _Defaults2.default.getDictData[0](model.dict, { key: value }, function (datas) {
                                    (0, _newArrowCheck3.default)(this, _this);
                ...
                if (this.readonly !== true) {
                    this.inst.grid.addEventListener('fin-editor-data-change', function (event) {
                        ...
                        var name = event.detail.input.column.schema.name;
                        var newValue = event.detail.newValue;
                        var oldValue = event.detail.oldValue;
                        var schema = event.detail.input.column.schema;
                        var row = event.detail.input.event.dataRow;
                        row[name] = newValue;

                        var index = event.detail.input.event.dataCell.y;
                        this.$emit("on-item-change", name, newValue, oldValue, schema, { row: row, index: index, name: this.name });
                        this.$emit("input", this.inst.getData());
                    }.bind(this));

                    this.inst.grid.addEventListener('tg-checkbox-change', function (event) {
                        (0, _newArrowCheck3.default)(this, _this2);

                        var name = event.detail.name;
                        var newValue = event.detail.value;
                        var schema = event.detail.schema;
                        var row = event.detail.dataRow;

                        var index = event.detail.dataCell.y;
                        this.$emit("on-item-change", name, newValue, undefined, schema, { row: row, index: index, name: this.name });
                        this.$emit("input", this.inst.getData());
                    }.bind(this));
                }

                this.inst.grid.addEventListener('fin-click', function (event) {
                    (0, _newArrowCheck3.default)(this, _this2);

                    var row = event.detail.row;
                    var rowIndex = event.detail.dataCell.y;
                    this.activedIndex = rowIndex;
                    this.$emit("on-highlight", row, rowIndex);
                }.bind(this));
                this.inst.grid.addEventListener('fin-row-header-clicked', function (event) {
                    (0, _newArrowCheck3.default)(this, _this2);
                ...
                this.inst.grid.addEventListener('fin-grid-rendered', function (event) {
                    (0, _newArrowCheck3.default)(this, _this2);
        ...
        setErrorCells: function setErrorCells(datas) {
            var _this3 = this;
...
module.exports = { render: function render() {
    var _vm = this;var _h = _vm.$createElement;var _c = _vm._self._c || _h;
    return _c('div', [_vm.showToolbar && _vm.readonly !== true ? _c('div', {
      staticClass: "toolbar",
      attrs: {
        "slot": "toolbar"
      },
      ...
      on: {
        "click": function click($event) {
          _vm.removeActivedRow();
        }
      }
    }, [_vm._v("删除选中行")])]) : _vm._e(), _vm._v(" "), _c('div', _vm._b({
      ref: "editableGrid",
      staticClass: "tg-editable-grid",
      style: {
        height: _vm.autoHeight + 'px'
      }
    }, 'div', _vm.params, false)), _vm._v(" "), _c('span', {
      attrs: {
        "id": _vm.uuid
      }
    })]);
...
exports.default = {
    name: "tg-form",
    extends: _FormConnector2.default,
    props: {
        type: {
            type: String,
            default: function _default() {
    ...
    data: function data() {
        var isGroupForm = _isGrouped(this.fields);
        var fields_and_rules = {};
        var tiledRules = {};
        var groupedRules = {};
        var groupedFields = [];
        var tiledFields = [];
    ...
    methods: {
        refresh: function refresh(newValue) {
            ...
            if (this.isGroupForm === true) {
                var fields_and_rules = _getGroupdFieldsAndRules(newValue);
                ...
                var _fields_and_rules = _getTiledFieldsAndRules(newValue);
                this.tiledFields = _fields_and_rules.fields;
                this.tiledRules = _fields_and_rules.rules;
        ...
        validate: function validate(callback) {
            ...
            if (this.isGroupForm === true) {
                ...
                var _loop = function _loop(form) {
                    var isGrouped = form.startsWith("group:[");
                    if (isGrouped === true) {
                        var group_rules = _this3.groupedRules[form];
                        _removeRequiredFalseRule(group_rules);
                        proms.push(new _promise2.default(function (resolve, reject) {
                            (0, _newArrowCheck3.default)(this, _this3);
                ...
                for (var form in this.$refs) {
                    _loop(form);
                }
                _promise2.default.all(proms).then(function (values) {
                    var _this2 = this;
        ...
        validateField: function validateField(prop, callback) {
            if (this.isGroupForm === true) {
                for (var form in this.$refs) {
                    var isGrouped = form.startsWith("group:[");
                    if (isGrouped === true) {
                        var group_rules = this.groupedRules[form];
                        _removeRequiredFalseRule(group_rules);
        ...
        getField: function getField(key) {
            ...
            var field_model = void 0;
            if (this.isGroupForm === true) {
                for (var i in this.groupedFields) {
                    var group = this.groupedFields[i];
                    field_model = group.items.find(function (item) {
                ...
                field_model = this.tiledFields.find(function (item) {
                    (0, _newArrowCheck3.default)(this, _this4);
                    return item.name === key;
                }.bind(this));
            }
...
function _getValidateRules(field, rules) {
    if (field.required !== undefined && field.hidden !== true) {
        ...
        var xtype = _Defaults2.default[_Defaults2.default.currentType].form[field.xtype || "static"];
        if (xtype !== undefined) {
            var required = xtype.required;
            if (required !== undefined) {
                var ctl = { required: field.required };
                if (field.dataType !== undefined) {
                    ctl["type"] = field.dataType;
                }
                rules[field.name].push((0, _assign2.default)({}, { field: field }, required, ctl));
            }
        }
    }
    if (field.validator !== undefined && field.hidden !== true) {
        ...
        if (field.validator.dataSize !== undefined || field.validator.checkSize) {
            var max = field.validator.checkSize !== undefined ? field.validator.checkSize : field.validator.dataSize;
            rules[field.name] = rules[field.name].concat((0, _assign2.default)({}, { field: field }, field.validator, { max: max, message: "\u5185\u5BB9\u592A\u957F\uFF0C\u4E0D\u80FD\u8D85\u8FC7 " + String(max) }));
        }
        if (field.validator.checkExp !== undefined) {
            rules[field.name] = rules[field.name].concat((0, _assign2.default)({}, { field: field }, field.validator, { type: 'pattern', pattern: field.validator.checkExp, message: field.validator.message }));
        } else if (field.validator.checkType !== undefined) {
            field.validator.checkType.split(',').map(function (item) {
                rules[field.name] = rules[field.name].concat((0, _assign2.default)({}, { field: field }, field.validator, { type: 'pattern', pattern: _Defaults2.default.validateRules[item].regex, message: _Defaults2.default.validateRules[item].alertText }));
            });
        }
...
function _isGrouped(fields) {
    ...
    return fields.some(function (item) {
        ...
        return item.name.startsWith("group:[") === true;
    }.bind(this));
}
...
function _getGroupdFieldsAndRules(fields) {
    ...
    var groupedRules = {};
    var groupedFields = fields.filter(function (group) {
        (0, _newArrowCheck3.default)(this, _this6);

        var isGrouped = group.name.startsWith("group:[");
        if (isGrouped) {
            var rules = {};
...
function _getTiledFieldsAndRules(fields) {
    ...
    var tiledRules = {};
    var tiledFields = fields.filter(function (item) {
...
module.exports = { render: function render() {
    var _vm = this;var _h = _vm.$createElement;var _c = _vm._self._c || _h;
    return _c('div', {
      staticClass: "tg-form-wrap"
    }, [_c('form', {
      ref: "syncForm",
      attrs: {
        "action": _vm.syncPostUrl,
        "target": "localFrame",
        "method": "POST",
        "enctype": "multipart/form-data"
      }
    }, [_vm._l(_vm.syncFields, function (item) {
      return _c('input', {
        key: item.key,
        attrs: {
          "type": "hidden",
    ...
    }), _vm._v(" "), _vm.isGroupForm ? _vm._l(_vm.groupedFields, function (item) {
      return _c(_vm.type + '-fc-group', {
        key: item.name,
        tag: "component",
        attrs: {
          "name": item.title,
        ...
        attrs: {
          "model": _vm.formValue,
          "fields": item.items.filter(function (item) {
            return item.hidden !== true;
          }),
          "value": _vm.value,
          "displayFieldFormat": _vm.displayFieldFormat,
          ...
          "validateRules": _vm.groupedRules[item.name]
        },
        on: {
          "on-value-change": _vm.updateValue
        }
        ...
        slot: "after"
      }), _vm._v(" "), _vm._l(item.items, function (model) {
        return _vm._t(model.name, null, {
          slot: model.name,
          model: model,
          value: _vm.formValue[model.name],
          display: _vm.formValue[model.name + _vm.displayFieldFormat]
        });
      })], 2)], 1);
    }) : [_c(_vm.type + '-fc-form', {
      ref: "tiled_form",
      ...
      slot: "after"
    }), _vm._v(" "), _vm._l(_vm.fields, function (model) {
      return _vm._t(model.name, null, {
        slot: model.name,
        model: model,
        value: _vm.formValue[model.name],
...
exports.default = {
    ...
    created: function created() {
        ...
        this.columns.filter(function (item) {
            (0, _newArrowCheck3.default)(this, _this);
            return item.filters !== undefined;
        }.bind(this)).map(function (col) {
            (0, _newArrowCheck3.default)(this, _this);
    ...
    methods: {
        ...
        sortHandler: function sortHandler(column, key, order) {
            this.sortFields = [{ column: column, key: key, order: order }];
        ...
        onHighlight: function onHighlight(currentRow, oldCurrentRow) {
...
module.exports = { render: function render() {
    var _vm = this;var _h = _vm.$createElement;var _c = _vm._self._c || _h;
    return _c('div', {
      staticClass: "tg-gridview-wrap"
    }, [_vm.searcher !== undefined ? _c(_vm.type + '-gb-' + _vm.searcher.name, _vm._b({
      tag: "component",
      attrs: {
        "fields": _vm.searcher.fields.filter(function (item) {
          return item.hidden !== true;
        }),
        "displayFieldFormat": _vm.displayFieldFormat
      },
      ...
      slot: "right"
    })], 2) : _vm._e(), _vm._v(" "), _c(_vm.type + '-gb-grid', {
      tag: "component",
      attrs: {
        "border": _vm.border,
        "columns": _vm.columns,
        ...
        "loading": _vm.loading,
        "displayFieldFormat": _vm.displayFieldFormat,
        "rowRending": _vm.rowRending
      },
      on: {
        "on-sort-change": _vm.sortHandler,
        "reload": _vm.tableReload,
        "on-highlight": _vm.onHighlight,
        "on-select-all": _vm.onSelectAll,
        "on-selection-change": _vm.onSelectionChange
      },
      scopedSlots: _vm._u([_vm._l(_vm.columns.filter(function (item) {
        return _vm.$scopedSlots['columns-' + item.key] !== undefined;
      }), function (model) {
        return {
          key: model.key,
          fn: function fn(scope) {
            return [_vm._t('columns-' + model.key, null, {
              index: scope.index,
              column: scope.column,
              row: scope.row
            })];
...
module.exports = { render: function render() {
    var _vm = this;var _h = _vm.$createElement;var _c = _vm._self._c || _h;
    return _c('div', {
      staticClass: "tg-left-right-item",
      style: _vm._style,
      on: {
        "click": _vm.handleClick
      }
...
exports.default = {
    ...
    methods: {
        ...
        setOtherHalfWidth: function setOtherHalfWidth(width, type) {
            var otherWidth = '';
            width = width.replace(/\s/g, '');
            if (this.checkWidth(width)) {
                otherWidth = 'calc(100% - ' + String(width) + ')';
            } else {
                otherWidth = '50%';
                width = '50%';
            }
        ...
        setChildAttr: function setChildAttr(left, right) {
...
exports.default = {
  ...
  created: function created() {
    if (this.grid) {
      var gutter = 0;
      if (this.grid.gutter !== "") {
        switch ((0, _typeof3.default)(this.grid.gutter)) {
          case "number":
      ...
      if (this.grid.column !== undefined && this.grid.column !== "") {
        var size = isNaN(Number(this.grid.column)) ? 24 : 24 / Number(this.grid.column);
...
module.exports = { render: function render() {
    var _vm = this;var _h = _vm.$createElement;var _c = _vm._self._c || _h;
    return _c('div', {
      staticClass: "tg-listview-root"
    }, [_c('div', {
      class: _vm.containerClass,
      style: _vm.containerStyle
    }, [_vm._t("beforeTemplate"), _vm._v(" "), _vm._l(_vm.list, function (item, index) {
      return item._lv_hidden !== true ? _c('div', {
        key: index,
        class: _vm.layoutClassObject,
        style: _vm.layoutStyle
      }, [_vm._t("itemTemplate", null, {
        data: item,
        index: index
      })], 2) : _vm._e();
    }), _vm._v(" "), _vm.list === undefined || _vm.list.length === 0 ? _c('div', [_vm._t("emptyTemplate", [_vm._v("暂无数据")])], 2) : _vm._e(), _vm._v(" "), _vm._t("afterTemplate")], 2), _vm._v(" "), _c('div', {
      staticStyle: {
        "clear": "both"
      }
    }, [_vm.pagination ? _vm._t("pagerTemplate", [_c('button', {
      on: {
        "click": _vm.LoadMore
      }
...
exports.default = {
    ...
    props: (_props = {
        ...
        selected: Array
    }, (0, _defineProperty3.default)(_props, "treeData", Array), (0, _defineProperty3.default)(_props, "type", {
        type: String,
        default: function _default() {
            if (_Defaults2.default.currentType !== undefined) {
                return _Defaults2.default.currentType;
    ...
    methods: {
        treeItemSelect_p: function treeItemSelect_p(data) {
            this.$emit("on-treeItemSelect", data);
        },
        check_p: function check_p(data) {
            this.$emit("on-check", data);
        },
        delete_p: function delete_p(data) {
...
module.exports = { render: function render() {
    var _vm = this;var _h = _vm.$createElement;var _c = _vm._self._c || _h;
    return _c('div', {
      staticClass: "tg-person-wrap"
    }, [_c('div', {
      staticClass: "us-modal"
    }, [_c('div', {
      staticClass: "tjyh-main"
    }, [_c(_vm.type + '-pe-left', {
      tag: "component",
      attrs: {
      ...
      on: {
        "on-treeItemSelect": _vm.treeItemSelect_p
      }
    }), _vm._v(" "), _c(_vm.type + '-pe-center', {
      tag: "component",
      attrs: {
        "users": _vm.users
      },
      on: {
        "on-check": _vm.check_p
      }
    }), _vm._v(" "), _c(_vm.type + '-pe-right', {
      tag: "component",
      attrs: {
        "selected": _vm.selected
      },
      on: {
        "on-delete": _vm.delete_p
      }
    })], 1)])]);
  }, staticRenderFns: [] };
...
module.exports = { render: function render() {
    ...
    }, [_vm.wordwrap ? _c('pre', [_vm._t("default")], 2) : _vm._t("default")], 2);
  }, staticRenderFns: [] };
...
module.exports = { render: function render() {
    var _vm = this;var _h = _vm.$createElement;var _c = _vm._self._c || _h;
    return _c('div', {
      staticClass: "tg-toolbar tg-clear"
    }, [_c('div', {
      staticClass: "tg-left"
    }, [_vm._t("left")], 2), _vm._v(" "), _c('div', {
      staticClass: "tg-right"
    }, [_vm._t("right")], 2)]);
  }, staticRenderFns: [] };
