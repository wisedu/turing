...
var install = function install(Vue) {
    ...
    Vue.filter('currency', function (value, symbol, format, precision, thousand, decimal) {
        ...
        return _accountingJs2.default.formatMoney(value, symbol, precision, thousand, decimal, format);
    });
    Vue.filter('percent', function (value, precision, thousand, decimal) {
        if (value === undefined || value === null || value === "") return '';
        return _accountingJs2.default.formatNumber(value, precision, thousand, decimal);
    });
};
