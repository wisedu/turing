...
function _getValidateRules(field, rules) {
    ...
    if (field.vaildator !== undefined && field.hidden !== true) {
        if (field.vaildator.dataSize !== undefined || field.vaildator.checkSize) {
            ...
            var max = Math.max(field.vaildator.dataSize || 0, field.vaildator.checkSize || 0);
            rules[field.name] = rules[field.name].concat((0, _assign2.default)({}, { field: field }, field.vaildator, { max: max, message: "\u5185\u5BB9\u592A\u957F\uFF0C\u4E0D\u80FD\u8D85\u8FC7 " + String(max) }));
        }
        if (field.vaildator.checkExp !== undefined) {
            if (rules[field.name] === undefined) {
                rules[field.name] = [];
            }
            rules[field.name] = rules[field.name].concat((0, _assign2.default)({}, { field: field }, { type: 'pattern', pattern: field.vaildator.checkExp, message: field.vaildator.message }));
