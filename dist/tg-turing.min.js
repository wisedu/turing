...
function _getValidateRules(field, rules) {
    ...
    if (field.validator !== undefined && field.hidden !== true) {
        ...
        if (field.validator.checkExp !== undefined) {
            rules[field.name] = rules[field.name].concat((0, _assign2.default)({}, { field: field }, { type: 'pattern', pattern: field.validator.checkExp, message: field.validator.message }));
        } else if (field.validator.checkType !== undefined) {
            field.validator.checkType.split(',').map(function (item) {
                rules[field.name] = rules[field.name].concat((0, _assign2.default)({}, { field: field }, { type: 'pattern', pattern: _Defaults2.default.validateRules[item].regex, message: _Defaults2.default.validateRules[item].alertText }));
            });
        }
